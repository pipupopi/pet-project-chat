...
export const MESSAGES = {
  MESSAGE_FORM: <HTMLFormElement>(
    document.querySelector(".message_form")
  ),
  MESSAGE_INPUT: <HTMLInputElement>(
    document.querySelector(".my_message-input")
  ),
  TEMPLATE: <HTMLTemplateElement>(
    document.querySelector("#template_other_message")
  ),
  MESSAGE_BLOCK: <HTMLDivElement>(
    document.querySelector(".other_message-block")
  ),
...
export const SETTINGS = {
  SETTINGS_WRAPPER: <HTMLDivElement>(
    document.querySelector(".settings_wrapper")
  ),
  BUTTON_SETTINGS: <HTMLButtonElement>(
    document.querySelector(".btn-settings")
  ),
  BUTTON_CLOSE_SETTINGS: <HTMLButtonElement>(
    document.querySelector("#settings-btn")
  ),
  CHANGE_NAME_FORM: <HTMLFormElement>(
    document.querySelector(".settings-form")
  ),
  CHANGE_NAME_INPUT: <HTMLInputElement>(
    document.querySelector("#change-name")
  ),
  MESSAGE_CHANGE_NAME: <HTMLParagraphElement>(
    document.querySelector(".result-message")
  ),
};

export const AUTHORIZATION = {
  AUTHORIZATION_WRAPPER: <HTMLDivElement>(
    document.querySelector(".authorization_wrapper")
  ),
  AUTHORIZATION_FORM: <HTMLFormElement>(
    document.querySelector(".authorization-form")
  ),
  AUTHORIZATION_MESSAGE: <HTMLParagraphElement>(
    document.querySelector(".message-authorization")
  ),
  BUTTONS_GET_CODE: document.querySelectorAll(".btn-get-code"),
  INPUT_MAIL: <HTMLInputElement>(
    document.querySelector("#input-for-mail")
  ),
};

export const CONFIRMATION = {
  CODE_INPUT: <HTMLInputElement>(
    document.querySelector("#input-for-code")
  ),
  CONFIRMATION_WRAPPER: <HTMLDivElement>(
    document.querySelector(".confirmation_wrapper")
  ),
  FORM_CONFIRMATION: <HTMLFormElement>(
...
export const ELEMENTS = {
  ...
  SCROLL_BLOCK: <HTMLDivElement>(
    document.querySelector(".message-window")
  ),
  SMILE: <HTMLButtonElement>(
    document.querySelector(".best-smile-ever")
  ),
  CODE: cookieGet("code") || CONFIRMATION.CODE_INPUT,
};
...
export const ANSWER_REQUEST: TYPE_ANSWER_REQUEST = {
  ...
  ERROR_CONNECT: "Error occurred in the connection",
  ERROR_SEND_MESSAGE: "Error occurred while sending messages",
